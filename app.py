...
with st.sidebar:
    ...
    st.markdown("<h6 style='padding-left: 20px;'>1. ZIP 파일 업로드</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>2. '파일 모으기 시작' 클릭</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>3. 압축 파일 다운로드</h6>", unsafe_allow_html=True)
    
    st.markdown("<h5>🎯 기능 2: 파일명 변경</h5>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>1. ZIP 파일 업로드</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>2. 확장자 & 정렬 기준 선택</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>3. 파일명 형식 선택</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>4. '파일명 변경 시작' 클릭</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>5. 압축 파일 다운로드</h6>", unsafe_allow_html=True)
    
    st.markdown("<h5>🎯 기능 3: 압축파일 자동 해제</h5>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>1. ZIP 파일 업로드</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>2. 옵션 선택</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>3. '압축파일 해제 시작' 클릭</h6>", unsafe_allow_html=True)
    st.markdown("<h6 style='padding-left: 20px;'>4. 처리된 파일 다운로드</h6>", unsafe_allow_html=True)
